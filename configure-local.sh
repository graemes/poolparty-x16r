...
#extracflags="-march=haswell -D_REENTRANT -falign-functions=16 -falign-jumps=16 -falign-labels=16 -save-temps"
extracflags="-march=haswell -D_REENTRANT -falign-functions=16 -falign-jumps=16 -falign-labels=16"

#CUDA_CFLAGS="-O3 -lineno -Xcompiler -Wall  -D_FORCE_INLINES --keep --keep-dir output/" \
